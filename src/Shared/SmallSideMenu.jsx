...
const SmallSideMenu = () => {
  return (
    <div className="flex h-[95vh] w-16 ml-[5%] rounded-xl flex-col justify-between border-e bg-white">
      <div>
        <Link
          to="/"
        ...
        <div className="border-t border-gray-100">
          <nav aria-label="Main Nav" className="flex flex-col p-2">
            ...
            <ul className="space-y-1 border-t border-b border-gray-100 pt-4">
              <li>
                <NavLink
                  to="/information"
                  className="group relative flex justify-center rounded px-2 py-1.5 text-gray-500 hover:bg-gray-50 hover:text-gray-700"
